...
color_dat <- tibble(
  colors = c("#006b99", "#339966", "#f00032", "#005b89", "#ffb612", "#2f72b3", "#ee2a2a", "#1d7fb9", "#c41200", "#496867"),
...
add_ribbons("VIH", "#339966") %>%
add_ribbons("VAS", "#f00032") %>%
add_ribbons("PER", "#005b89") %>%
add_ribbons("MUUT", "#ffb612") %>%
add_ribbons("KES", "#2f72b3") %>%
add_ribbons("SDP", "#ee2a2a") %>%
...
ggl_all %>% 
  ...
  gtExtras::gt_theme_538() %>% 
  tab_options(table.width = pct(100))  %>%
add_ribbons2("KOK", "#006b99") %>%
add_ribbons2("VIH", "#339966") %>%
# add_ribbons2("VAS", "#f00032") %>%
# add_ribbons2("PER", "#005b89") %>%
# add_ribbons2("MUUT", "#ffb612") %>%
add_ribbons2("KES", "#2f72b3") %>%
add_ribbons2("SDP", "#ee2a2a") #%>%
# add_ribbons2("KD", "#1d7fb9")# %>%
# add_ribbons2("KOR", "#c41200")
```
...
ggl_all7 %>% 
  ...
  gtExtras::gt_theme_538() %>% 
  tab_options(table.width = pct(100))  %>%add_ribbons2("KOK", "#006b99")  %>%
add_ribbons2("KOK", "#006b99") %>%
# add_ribbons2("VIH", "#339966") %>%
# add_ribbons2("VAS", "#f00032") %>%
# add_ribbons2("PER", "#005b89") %>%
